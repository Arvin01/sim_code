...
library(dplyr)
library(stringr)
tissuedat <- read.csv("../../../data/gtex_tissue_gene_reads/muscle.csv")
...
Save file
```{r}
muscle <- list(Y = Y, X = X, ctl = ctl, chrom = subtissue$CHR)
save(muscle, file = "../output/cleaned_gtex_data/muscle.Rd")
```
