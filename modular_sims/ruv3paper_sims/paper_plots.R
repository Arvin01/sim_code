...
cov_mat <- select(cov_mat, -ruvem)
colnames(cov_mat)[6:ncol(cov_mat)] <- c("OLS", "RUV2", "RUV3", "RUV4", "CATE", "RUVB")

auc_mat <- select(auc_mat, -ruvem)
colnames(auc_mat)[6:ncol(auc_mat)] <- c("OLS", "RUV2", "RUV3", "RUV4", "CATE", "RUVB")
