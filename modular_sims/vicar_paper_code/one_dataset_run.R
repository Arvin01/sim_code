...
colnames(pmat) <- c("OLS", "SVA", "RUV2", "RUV4", "RUVinv", "CATEnc", "CalCATEnc", "CATErr", "CalCATErr", "VICAR", "seed")
...
colnames(pmat) <- c("OLS", "SVA", "RUV2", "RUV4", "RUVinv", "CATEnc", "CalCATEnc", "CATErr", "CalCATErr", "VICAR", "seed", "which_null")
