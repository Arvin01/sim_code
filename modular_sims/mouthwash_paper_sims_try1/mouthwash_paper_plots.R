...
ggplot(data = auc_mean, mapping = aes(x = Nsamp, y = avg, color = variable)) +
...
## plot!
pdf(file = "auc_ave.pdf", family = "Times", width = 6.5, height = 7, colormodel = "cmyk")
...
pdf(file = "pi0_med.pdf", family = "Times", colormodel = "cmyk", height = 7, width = 6.5)
...
pdf(file = "pi0_box_09.pdf", family = "Times", colormodel = "cmyk", height = 7, width = 6.5)
...
pdf(file = "pi0_box_05.pdf", family = "Times", colormodel = "cmyk", height = 7, width = 6.5)
ggplot(data = subdat, mapping = aes(y = value, x = variable)) +
    facet_grid(Nsamp ~ ncontrols) +
    geom_boxplot(outlier.size = 0.1, lwd = 0.5) +
    theme_bw() +
...
pdf(file = "pi0_box_1.pdf", family = "Times", colormodel = "cmyk", height = 7, width = 6.5)
ggplot(data = subdat, mapping = aes(y = value, x = variable)) +
    facet_grid(Nsamp ~ ncontrols) +
    geom_boxplot(outlier.size = 0.1, lwd = 0.5) +
    theme_bw() +
