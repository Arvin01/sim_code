...
num_sv_seq <- c(33, 1, 32, 20, 14, 6, 25, 24, 19, 21, 15, 17, 20, 16,
                20, 21, 15, 32, 15, 8, 7, 12, 29)
...
## prop_array2 <- prop_array[order(prop_array[, "RUVB", "100"]),,]
...
pdf(file = "propk.pdf", family = "Times", height = 5, width = 6.5)
print(pgd)
dev.off()
